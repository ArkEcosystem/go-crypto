...
func TestSerialiseTransfer(t *testing.T) {
	serialized := ""
	transaction := DeserializeTransaction(serialized)

	assert := assert.New(t)
	assert.Equal(serialized, HexEncode(SerialiseTransaction(transaction)))
}
...
func TestSerialiseDelegateRegistration(t *testing.T) {
	serialized := ""
	transaction := DeserializeTransaction(serialized)
